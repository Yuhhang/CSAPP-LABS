...
0000000000401338 <strings_not_equal>:
  ...
  401347:	41 89 c4             	mov    %eax,%r12d                       ;长度存储在r12
  40134a:	48 89 ef             	mov    %rbp,%rdi
  40134d:	e8 c9 ff ff ff       	callq  40131b <string_length>
  401352:	ba 01 00 00 00       	mov    $0x1,%edx                        ;设置edx为1
  401357:	41 39 c4             	cmp    %eax,%r12d                       ;比较两字符串的长度
  40135a:	75 3f                	jne    40139b <strings_not_equal+0x63>  ;不相等就跳转至40139b
  ...
  40139b:	89 d0                	mov    %edx,%eax                        ;将结果移至eax准备返回
  40139d:	5b                   	pop    %rbx
  40139e:	5d                   	pop    %rbp
...
000000000040145c <read_six_numbers>:
  ...
  401460:	48 89 f2             	mov    %rsi,%rdx                ;rsi中存储栈顶指针
  401463:	48 8d 4e 04          	lea    0x4(%rsi),%rcx           ;rcx中分配4个字节
  401467:	48 8d 46 14          	lea    0x14(%rsi),%rax          ;rax中分配16个字节
